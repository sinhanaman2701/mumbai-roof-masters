    ...
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <span className="text-xl font-bold text-gray-900">Mumbai Roof Masters</span>
      ...
      <section className="bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 text-white py-20 lg:py-28">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Best Roofing in Mulund Mumbai</h1>
          <p className="text-xl md:text-2xl mb-8">Trusted by 1,600+ customers</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="tel:9865321098" className="border-2 border-white px-8 py-4 rounded-xl font-bold hover:bg-white/10 flex items-center justify-center gap-2"><Phone size={20} /> 9865321098</a>
          </div>
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="text-center"><div className="text-4xl font-bold">10+</div><div className="text-blue-200">Years</div></div>
            <div className="text-center"><div className="text-4xl font-bold">1,600+</div><div className="text-blue-200">Clients</div></div>
      ...
      <section id="about" className="py-16 lg:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">About Mumbai Roof Masters</h2>
          <p className="text-gray-600 text-lg mb-4">Welcome to Mumbai Roof Masters, your trusted roofing provider in Mulund Mumbai. With over 10 years of experience serving thousands of satisfied customers.</p>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8">
            <div className="bg-white p-6 rounded-xl shadow-md text-center"><Users className="mx-auto text-blue-600 mb-3" size={32} /><div className="text-3xl font-bold">1,600+</div><div className="text-gray-600">Clients</div></div>
      ...
      <section id="services" className="py-16 lg:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition border border-gray-100"><div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-5"><Wrench className="text-blue-600" size={28} /></div><h3 className="text-xl font-bold mb-3">Maintenance</h3><p className="text-gray-600">Professional maintenance services.</p></div>
            <div className="bg-gray-50 rounded-2xl p-8 hover:shadow-xl transition border border-gray-100"><div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center mb-5"><Wrench className="text-blue-600" size={28} /></div><h3 className="text-xl font-bold mb-3">Tile Repair</h3><p className="text-gray-600">Professional tile repair services.</p></div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 bg-blue-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition"><CheckCircle className="mx-auto mb-4" size={40} /><h3 className="text-lg font-bold">Skilled Roofers</h3></div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition"><CheckCircle className="mx-auto mb-4" size={40} /><h3 className="text-lg font-bold">Modern Tech</h3></div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition"><CheckCircle className="mx-auto mb-4" size={40} /><h3 className="text-lg font-bold">Affordable</h3></div>
            <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-6 text-center hover:bg-white/20 transition"><CheckCircle className="mx-auto mb-4" size={40} /><h3 className="text-lg font-bold">Timely</h3></div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 gap-12">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex items-center gap-4"><div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center"><Phone className="text-blue-600" size={24} /></div><div><div className="text-gray-500 text-sm">Call Us</div><div className="text-xl font-bold">9865321098</div></div></div>
                <div className="flex items-center gap-4"><div className="w-14 h-14 bg-blue-100 rounded-xl flex items-center justify-center"><MapPin className="text-blue-600" size={24} /></div><div><div className="text-gray-500 text-sm">Location</div><div className="text-xl font-bold">Mulund Mumbai</div></div></div>
      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <div className="flex items-center justify-center gap-3 mb-4"><span className="text-3xl">🏠</span><span className="text-xl font-bold">Mumbai Roof Masters</span></div>
          <p className="text-gray-400">Your trusted roofing provider in Mulund Mumbai</p>
          <p className="mt-8 text-gray-400">© 2026 Mumbai Roof Masters. All rights reserved.</p>
        </div>
      </footer>
    </div>
  );
